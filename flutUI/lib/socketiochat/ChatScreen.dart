...
import 'package:flutUI/socketiochat/ChatMessageModel.dart';
import 'package:flutUI/socketiochat/ChatTittle.dart';
import 'package:flutUI/socketiochat/SocketUtils.dart';
...
class ChatScreenState extends State<ChatScreen> {
  ...
  _addMessage(id, ChatMessageModel chatMessageModel, fromMe) async {
    ...
    print("======================= ${chatMessageModel.isFromMe}");
